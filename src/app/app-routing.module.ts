...
,{path:'Login-As-Pharmacist',component:LoginAsPharmacistComponent},{path:'Login-As-Vet',component:LoginAsVetComponent},{path:'Login-As-Owner',component:LoginAsOwnerComponent}
];
